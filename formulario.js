...
const SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbyctlyj2kUC6YaWR5yzJ5V9aRFEnBcOITa3l78CYAZR5u-IgjKQoidTWX0aK5M28Lsg/exec';
...
function recopilarDatos(paqueteKey) {
  ...
  const datos = {
    ...
    mapsCeremonia:          val('mapsCeremonia'),
    wazeCeremonia:          val('wazeCeremonia'),
    lugarRecepcion:         val('lugarRecepcion'),
    mapsRecepcion:          val('mapsRecepcion'),
